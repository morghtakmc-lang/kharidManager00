...
public class MainActivity extends Activity {
    ...
    void buyerFile(String buyer){
        ...
        Button certs=btn("📂 خرید بر اساس گواهی بهداشتی");
        certs.setOnClickListener(v->openPage(()->certificateIndex(buyer)));add(certs);
